...
def _write_report(summary_df: pd.DataFrame, metrics: dict) -> None:
    ...
    lines.append("")
    lines.append("### Mean Expected Loss by Scenario")
    lines.append("![Mean Expected Loss by Scenario](figures/mean_expected_loss_by_scenario.png)")
    lines.append("")
    lines.append("### Expected Loss Distribution by Scenario")
    lines.append("![Expected Loss Distribution by Scenario](figures/expected_loss_boxplot_by_scenario.png)")
    lines.append("")
    lines.append("### Top 10 Tracts by Expected Loss (Northridge)")
    lines.append("![Top 10 Tracts by Expected Loss (Northridge)](figures/northridge_top10_tracts.png)")
    lines.append("")
    lines.append("### Mean Damage Ratio by Building Era (Northridge)")
    lines.append("![Mean Damage Ratio by Building Era (Northridge)](figures/northridge_damage_ratio_by_era.png)")
    lines.append("")
